...
Tech: Python, Pandas, Seaborn (Logarithmic Analysis), JSON.

📦 Inventory Quality Audit (ICQA)
Automated anomaly detection for warehouse logistics, digitizing manual quality control workflows.
